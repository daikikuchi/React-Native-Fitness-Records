...
export function setLocalNotification () {
  // we use AsyncStorage to check getItem to see if our Notification has been se
        ...
        Permissions.askAsync(Permissions.NOTIFICATIONS)
          .then(({ status }) => {
            ...
            if (status === 'granted') {
              ...
              // we'll clear all the local notifications just in case we don't set t
           ...
           // create data object
              ...
              Notifications.scheduleLocalNotificationsAsync(
                createNotification(),
                {
                  time: tomorrow, // time we wanted to run is tomorrow
                  repeat: 'day', // we want to repeat daily
                }
              )
    //what we want to do is we want to make sure that we establish inside of AsyncStorage
